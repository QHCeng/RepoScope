...
# Add the WebSocket endpoint (optional - only if websocket_wiki module exists)
try:
    from api.websocket_wiki import handle_websocket_chat
    app.add_websocket_route("/ws/chat", handle_websocket_chat)
    logger.info("WebSocket endpoint enabled at /ws/chat")
except ImportError:
    logger.warning("WebSocket support not available (websocket_wiki module not found). HTTP streaming endpoint is still available.")
